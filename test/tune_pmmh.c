...
static double randu(void) {
    ...
    return (double)(g_seed & 0x7FFFFFFF) / 2147483648.0;
}
static double randn(void) {
    double u1 = randu(), u2 = randu();
    return sqrt(-2.0 * log(u1 + 1e-10)) * cos(6.283185307 * u2);
}
...
int main(void) {
    ...
    /* Test configurations */
    int particles[] = {64, 128, 256, 512};
    int iterations[] = {200, 300, 500, 800};
    ...
    int best_particles[] = {128, 256, 512};
